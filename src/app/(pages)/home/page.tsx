...
const HomePage = () => {
    return (
        <WrapperLayout className='relative '>
            <iframe src='https://my.spline.design/thresholddarkambientuicopy-TdFiRssh4jmmRXTHTQPp1U0N/' className="w-full absolute top-0 left-0 h-screen bg-black -z-10"></iframe>

        ...
        <WrapperLayout>
            ...
            <section className="bg-background py-16" id='customers'>
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto md:mt-20 mt-10 md:flex grid grid-cols-2 max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12">
